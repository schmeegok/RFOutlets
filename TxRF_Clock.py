...
if __name__ == '__main__':
    ...
    while True:
        ...
        """# Turn on lights at 5:00 AM - 7:00 AM
        if currentTime.tm_hour == 5 and currentTime.tm_min == 0 and currentTime.tm_sec == 0:
            lightsOn_P2(10)
            
        if currentTime.tm_hour == 7 and currentTime.tm_min == 0 and currentTime.tm_sec == 0:
            lightsOff()"""
            
        # Turn on lights at 5:00:00 AM
        if currentTime.tm_hour == 5 and currentTime.tm_min == 0 and currentTime.tm_sec == 0:
            lightsOff()
            time.sleep(10)
            treeOn(20)
